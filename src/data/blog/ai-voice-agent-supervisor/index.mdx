...
<Figure src="/images/ai-voice-agent-supervisor/animation_bubble.gif" caption="Bubble view in action. Red = angry customer, green = happy customer. The pulsing means someone's talking right now." />
...
<Figure src="/images/ai-voice-agent-supervisor/card_view.png" caption="Traditional card grid view for when you want details without the fancy graphics." />
...
<Figure src="/images/ai-voice-agent-supervisor/room_view.png" caption="Inside a call. Live transcript on the left, audio controls on the right, debug panel at the bottom." />
...
<Figure src="/images/ai-voice-agent-supervisor/control_bar.png" caption="The 'oh shit' buttons. Mute the AI, take over, or transfer to a human agent." />
...
<Figure src="/images/ai-voice-agent-supervisor/post_call.png" caption="Post-call analytics dashboard" />
...
<Figure src="/images/ai-voice-agent-supervisor/debug_events.png" caption="Debug panel showing live agent state transitions and performance metrics" />
...
---
<Figure src="/images/ai-voice-agent-supervisor/metrics.png" caption="Debug panel with live events" />
