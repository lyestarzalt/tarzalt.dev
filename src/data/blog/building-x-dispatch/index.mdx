...
Most of the features that came after were from users asking for them. One person in particular, Gilles from France, gave me the best bug reports I've ever seen. Detailed reproduction steps, screenshots, everything tracked in a Google Sheet. A lot of the features he proposed made the app noticeably better, and some of the bugs he caught would have been deal breakers. I owe him a lot.

A community started growing around the app. I had to set up a Discord server for it, which wasn't something I planned. FSElite [covered the app](https://fselite.net/content/x-dispatch-adds-world-map-flight-launcher-and-add-on-manager-to-x-plane-12/). 19 reviews on X-Plane.Org, most of them five stars. The encouraging words mean a lot to me.

I've been flying in flight sims since I was a kid. Started with FSX, moved to P3D, then X-Plane 10, and now 12. This app is a thank you to a community that gave me so many hours of fun. I'm proud of how it turned out.
