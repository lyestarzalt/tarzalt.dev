...
<div className="flex flex-wrap gap-1.5 mb-4">
  ...
  <Badge variant="secondary">flutter_map</Badge>
</div>
...
<Card className="my-6">
  <CardContent className="p-5">
    <p className="text-sm font-medium text-foreground mb-3">The stack I landed on</p>
    <div className="flex flex-wrap gap-1.5">
      <Badge>Electron</Badge>
      <Badge>React 18</Badge>
      <Badge>TypeScript</Badge>
      <Badge>MapLibre GL JS</Badge>
...
<div className="flex flex-wrap gap-2">
  <Button asChild>
    <a href="https://github.com/lyestarzalt/x-dispatch/releases/latest" target="_blank" rel="noopener">Download X-Dispatch</a>
  </Button>
  <Button variant="outline" asChild>
    <a href="/projects/x-dispatch/">Project page</a>
  </Button>
  <Button variant="outline" asChild>
    <a href="https://github.com/lyestarzalt/x-dispatch" target="_blank" rel="noopener">GitHub</a>
  </Button>
</div>
