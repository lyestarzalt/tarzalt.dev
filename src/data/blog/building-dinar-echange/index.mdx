...
import currenciesImg from '@/assets/projects/dinar-echange/screenshots/screenshot-currencies.webp';
import converterImg from '@/assets/projects/dinar-echange/screenshots/screenshot-converter.png';
import trendsImg from '@/assets/projects/dinar-echange/screenshots/screenshot-trends.png';

A friend wanted an easy way to check Algerian dinar exchange rates. Not the official bank rate that the government publishes. The real one. The parallel market rate that everyone uses in practice.

If you're not familiar with Algeria, there's a big gap between the official exchange rate and what you'd get if you exchanged money on the street. Everyone knows this. Nobody talks about it officially. And there's no API for it.
...
The scrapers only get rates for the major currencies people trade on the parallel market: EUR, USD, GBP, CAD, a handful of others. These are the "core" currencies.
